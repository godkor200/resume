...
export const careers: Array<{
...
}> = [
  {
    ...
    achievements: [
      'K-POP Radar 백엔드 전반 설계 및 구현 — 일 평균 100만 건 데이터 처리, 아티스트 300여명 / 앨범 600건 이상 규모',
  ...
  },
  {
    ...
    achievements: [
      '일평균 1GB 규모 유튜브 콘텐츠 분석 데이터 파이프라인 설계 및 구축',
      'NestJS, TypeORM, MariaDB, OpenSearch 기반 데이터 파이프라인 및 API 설계',
      '다중 조인 기반 병목 분석 후 비정규화·집계 테이블 전략 적용 — 핵심 집계 API 응답속도 40초 → 3초 개선',
  ...
  },
  {
    ...
    achievements: [
      ...
      '낙관적 잠금(Optimistic Locking) 적용으로 재고 동시 수정 문제 해결 — 재고 관련 CS 건수 약 50% 감소',
...
export const portfolio = [
  {
    ...
    notion: 'https://www.notion.so/Backend-Portfolio-17226d4c90ec80219c8cf70782c9d5ad#32f26d4c90ec806fbff1d4ebea9058fd',
  ...
  },
  {
    ...
    notion: 'https://www.notion.so/Backend-Portfolio-17226d4c90ec80219c8cf70782c9d5ad#32f26d4c90ec80518864fe1449bcc3fe',
  ...
  },
  {
    ...
    notion: 'https://www.notion.so/Backend-Portfolio-17226d4c90ec80219c8cf70782c9d5ad#32f26d4c90ec8091bce1d98aa00ff332',
