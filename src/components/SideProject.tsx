                  ...
                  <div className="flex items-center gap-2 flex-wrap mb-1">
                    ...
                    {project.url && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-1 text-xs text-blue-500 hover:text-blue-700 transition-colors border border-blue-200 rounded px-2 py-0.5"
                      >
                    ...
                    {'blog' in project && project.blog && (
                      <a
                        href={project.blog as string}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-1 text-xs text-green-600 hover:text-green-800 transition-colors border border-green-200 rounded px-2 py-0.5"
                      >
                        <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
